...
<div class="cart_totals <?php echo (WC()->customer->has_calculated_shipping()) ? 'calculated_shipping' : ''; ?>">
    ...
    <h2><?php esc_html_e('Totaal winkelwagen', 'woocommerce'); ?></h2>

    <table cellspacing="0" class="shop_table shop_table_responsive">

        <tr class="cart-subtotal hidden">
            <th><?php esc_html_e(COURSE_CART_LBL["subtotal_lbl"], 'woocommerce'); ?></th>
        ...
        <tr class="order-total order-total-mobile">
            <th><?php esc_html_e('Total', 'woocommerce'); ?></th>
            <td data-title="<?php esc_attr_e('Total', 'woocommerce'); ?>"><?php apply_filters('wc_cart_totals_order_total_html', ''); ?></td>
        </tr>
